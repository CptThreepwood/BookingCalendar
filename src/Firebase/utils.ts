...
import { AllYears, YearData, MonthData, BedsBooked } from './types';
...
export function bookingAtKey(
    data: AllYears | undefined, year: number, month: number, day: number
): BedsBooked[] | undefined
export function bookingAtKey(
    data: AllYears | undefined, year: number, month: number, day: undefined
): MonthData | undefined
export function bookingAtKey(
    data: AllYears | undefined, year: number, month: undefined, day: undefined
): YearData | undefined
export function bookingAtKey(
    data: AllYears | undefined,
    year: number,
    month: number | undefined,
    day: number | undefined
): BedsBooked[] | MonthData | YearData | undefined {
    if (data === undefined || data[year] === undefined) { return undefined; }
